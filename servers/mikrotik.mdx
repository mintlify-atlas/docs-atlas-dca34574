...
description: MCP server for monitoring and managing MikroTik routers using the RouterOS API with comprehensive system reporting and security auditing
---
...
Generates an Automatic Workload Repository (AWR) style report for MikroTik.
...
<Steps>
  <Step title="Navigate to the mikrotik directory">
    ```bash
    cd src/mikrotik
    ```
  </Step>
