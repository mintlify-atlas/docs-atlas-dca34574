...
<CardGroup cols={2}>
  <Card title="Everything" icon="cube" href="/servers/everything">
    Reference server with prompts, resources, and tools for testing
  </Card>
  <Card title="Fetch" icon="globe" href="/servers/fetch">
    Web content fetching and HTML to markdown conversion
  </Card>
  <Card title="Filesystem" icon="folder" href="/servers/filesystem">
    Secure file operations with configurable access controls
  </Card>
  <Card title="Git" icon="code-branch" href="/servers/git">
    Git repository interaction and automation
  </Card>
  <Card title="Memory" icon="brain" href="/servers/memory">
    Knowledge graph-based persistent memory system
  </Card>
  <Card title="Sequential Thinking" icon="list-tree" href="/servers/sequential-thinking">
    Dynamic problem-solving through thought sequences
  </Card>
  <Card title="Time" icon="clock" href="/servers/time">
